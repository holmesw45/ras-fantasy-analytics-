...
Data
•	Combine and pro day measurements — 8,647 players, 2007–2026, from the array-carpenter/nfl-draft-data repository. Uses the coalesced dataset, which fills in pro day numbers where official combine results are missing.
...
models/
  staging/
    stg_combine_percentiles.sql   -- computes 10 within-position percentiles
    stg_fantasy_stats.sql         -- normalizes player names
    stg_ras_scores.sql
  marts/
    ras_scores.sql                -- composite 0–10 score
    ras_ppg_2024.sql              -- joins scores to fantasy production
    ras_percentiles_2024.sql
